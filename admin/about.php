								...
								<div class="addform-custom">
									<form method="post" name="category">
									  <div class="form-group row">
									    <label for="" class="col-sm-2 col-form-label font-weight-bold">About Title</label>
									    <div class="col-sm-8">
									      <input type="text" class="form-control" id="" name="cat" placeholder="">
									    </div>
									  </div>
									  <div class="form-group row">
									    <label for="" class="col-sm-2 col-form-label font-weight-bold">About Description</label>
									    <div class="col-sm-8">
