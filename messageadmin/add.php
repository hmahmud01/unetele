...
// if the form's submit button is clicked, we need to process the form
    ...
    $detail = $_POST['detail'];
		...
		$sql = "INSERT INTO `messages`(`title`, `detail`) VALUES ('$title','$detail')";
...
<nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="#">United TeleDoc</a>
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
      ...
      <form action="" method="post">
          <div class="form-group">
              <label>Title</label>
              <input type="text" name="title" class="form-control" placeholder="Add A Title to the message">
          </div>
          <div class="form-group">
              <label>Detail</label>
              <textarea name="detail" class="form-control" placeholder="Add Detail Message"></textarea>
          </div>
